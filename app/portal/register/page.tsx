...
export default function PortalRegisterPage() {
    return (
        <div className="min-h-screen bg-canvas text-ink relative overflow-hidden flex items-center justify-center p-6 py-12">
            {/* Background */}
            ...
            <div className="w-full max-w-lg relative z-10">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-ink/60 text-sm uppercase tracking-[0.2em] font-medium">
                ...
                <div className="glass-panel p-8 bg-white/80">
                    <h2 className="text-2xl font-bold text-ink mb-6">Crear Cuenta</h2>
