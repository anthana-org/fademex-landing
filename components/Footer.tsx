...
export default function Footer() {
  return (
    <footer className="border-t border-ink/15 bg-ink pt-20 pb-10 text-canvas">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            <img
              src="/logos/FADEMEX%20LOGOTIPOS%20-06.svg"
              alt="FADEMEX"
          ...
          <div>
            <h4 className="text-canvas font-extrabold mb-6">Soluciones</h4>
          ...
          <div>
            <h4 className="text-canvas font-extrabold mb-6">Compañía</h4>
            <ul className="space-y-3 text-sm text-canvas/70">
              <li>
                <Link
                  href="/"
          ...
          <div>
            <h4 className="text-canvas font-extrabold mb-6">Contacto</h4>
            <ul className="space-y-3 text-sm text-canvas/70">
        ...
        <div className="border-t border-ink/20 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-xs text-canvas/50">
            <Link href="/" className="hover:text-canvas transition-colors">
              Privacidad
            </Link>
            <Link href="/" className="hover:text-canvas transition-colors">
              Términos
