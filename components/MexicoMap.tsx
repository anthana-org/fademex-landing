...
export default function MexicoMap() {
    ...
    // Coordinates calibrated for 1024x1024 SVG viewbox
                    ...
                    <g>
                        {projects.map((proj) => (
                            ...
                            >
                                ...
                                {/* ForeignObject Tooltip for easy HTML/Tailwind styling within SVG */}
                                <foreignObject x="-100" y="-120" width="200" height="100"
